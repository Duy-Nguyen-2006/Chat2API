...
This project is indexed by GitNexus as **Chat2API** (127 symbols, 301 relationships, 16 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
- Core skill: `.cursor/skills/codemod/SKILL.md`
- Package skills: `.cursor/skills/<package-skill>/SKILL.md`
...
- List installed Codemod skills: `npx codemod ai list --harness cursor --format json`

<!-- codemod-skill-discovery:end -->
Rule: Luôn có câu "Sax báo cáo" ở cuối response
